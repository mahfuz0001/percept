            ...
            <div className="h-64 flex items-end justify-between space-x-2">
              {[
                ...
                <div key={index} className="flex flex-col items-center flex-1">
                  <div
                    className="w-full bg-blue-100 rounded-t-lg relative mb-2"
                    style={{ height: `${Math.max(data.time / 2.4, 10)}px` }}
                  >
                    <div
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-700 text-sm">
                  You perform best between 2 PM - 4 PM with 92% success rate
                </p>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <p className="text-green-700 text-sm">
                  CSS - 90% mastery level with consistent improvement
                </p>
              </div>
              ...
              <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <p className="text-yellow-700 text-sm">
                  Node.js challenges show the most potential for skill
                  development
                </p>
              </div>
              ...
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                ...
                <p className="text-purple-700 text-sm">
                  You prefer intermediate challenges and use hints strategically
                </p>
              </div>
            </div>
          </div>
