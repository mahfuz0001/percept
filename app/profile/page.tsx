              ...
              <CardContent className="p-6 text-center">
                ...
                <div className="mb-4">
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>
                      {userProfile.totalXP} /{" "}
                      {userProfile.totalXP + userProfile.xpToNextLevel}
                    </span>
                  </div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {userProfile.xpToNextLevel} XP to Level{" "}
                    {userProfile.level + 1}
                  </p>
                </div>
                    ...
                    <div key={index}>
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-sm text-gray-600">
                          {topic.completed} / {topic.total} challenges
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-3">
                        <div
        ...
        <Card className="mt-8 bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-200">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
              Complete learning paths and demonstrate mastery to earn official
              certificates that showcase your skills to employers and peers.
            </p>
